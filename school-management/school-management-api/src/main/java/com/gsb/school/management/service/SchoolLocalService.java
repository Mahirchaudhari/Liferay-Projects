...
public interface SchoolLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SchoolLocalServiceUtil} to access the school local service. Add custom service methods to <code>com.gsb.school.management.service.impl.SchoolLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	@Indexable(type = IndexableType.REINDEX)
	public School addSchool(
			long userId, String name, String city, String state,
			long totalStudents, int rating, ServiceContext serviceContext)
	...
	@Indexable(type = IndexableType.DELETE)
	public School deleteSchool(long schoolId, ServiceContext serviceContext)
		throws PortalException;
